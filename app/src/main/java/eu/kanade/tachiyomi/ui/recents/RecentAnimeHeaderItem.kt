...
class RecentAnimeHeaderItem(val recentsType: Int) :
    AbstractHeaderItem<RecentAnimeHeaderItem.Holder>() {
    ...
    override fun createViewHolder(
        ...
        return Holder(view, adapter as RecentAnimeAdapter)
    }
    ...
    class Holder(val view: View, adapter: RecentAnimeAdapter) : BaseFlexibleViewHolder(
        view,
        adapter,
        true,
    ) {
        ...
        fun bind(recentsType: Int) {
            binding.title.setText(
                when (recentsType) {
                    CONTINUE_READING -> MR.strings.continue_reading // Maybe rename string resource to continue_watching
                    NEW_CHAPTERS -> MR.strings.new_chapters // Maybe rename string resource to new_episodes
