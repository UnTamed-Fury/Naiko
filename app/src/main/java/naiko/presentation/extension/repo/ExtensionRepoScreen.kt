package naiko.presentation.extension.repo
...
import naiko.presentation.component.EmptyScreen
import naiko.presentation.component.ToolTipButton
import naiko.presentation.core.enterAlwaysAppBarScrollBehavior
import naiko.presentation.extension.repo.component.ExtensionRepoInput
import naiko.presentation.extension.repo.component.ExtensionRepoItem
...
class ExtensionRepoScreen(
    ...
    override fun Content() {
        ...
        NaikoScaffold(
            ...
            if (state is ExtensionRepoScreenModel.State.Loading) return@NaikoScaffold
